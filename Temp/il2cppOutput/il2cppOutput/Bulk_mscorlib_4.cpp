...
{
	{
		...
		NullCheck(L_0);
		Type_t * L_3 = VirtFuncInvoker2< Type_t *, String_t*, bool >::Invoke(41 /* System.Type System.Type::GetInterface(System.String,System.Boolean) */, L_0, L_1, L_2);
		return L_3;
	}
}
...
{
	{
		Type_t * L_0 = __this->get_typeImpl_8();
		NullCheck(L_0);
		TypeU5BU5D_t1664964607* L_1 = VirtFuncInvoker0< TypeU5BU5D_t1664964607* >::Invoke(42 /* System.Type[] System.Type::GetInterfaces() */, L_0);
		return L_1;
	}
}
...
{
	{
		...
		int32_t L_1 = ___bindingAttr0;
		NullCheck(L_0);
		MethodInfoU5BU5D_t152480188* L_2 = VirtFuncInvoker1< MethodInfoU5BU5D_t152480188*, int32_t >::Invoke(57 /* System.Reflection.MethodInfo[] System.Type::GetMethods(System.Reflection.BindingFlags) */, L_0, L_1);
		return L_2;
	}
}
